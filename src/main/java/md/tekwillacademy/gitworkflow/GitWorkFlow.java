...
public class GitWorkFlow {
    public static void main(String[] args) {
        ...
        String step13 = "if someone asks for changes then we can merge the changes and continue with another task";
        String step14 ="Change the requested lines of code";
        String step15 = "Perform a git commit amend to change the latest executed commit by adding your recent requested changes";
        String step16 = "Perform a git force push to update the status of pul request";
